    ...
    >
      <Wrapper className="h-[60px] flex justify-between items-center">
        <Link href={"/"} className="flex">
          ...
          <h1 className="font-[500] text-[30px] font-great-vibes">Saif Alam</h1>
        </Link>
        ...
        <div className="flex items-center gap-2 text-black">
          {/* Icon start */}
          <div className="w-8 md:w-12 h-8 md:h-12 rounded-full flex justify-center items-center hover:bg-[#a855f7]/[0.5] cursor-pointer relative">
